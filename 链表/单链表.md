...
Java中的LinkedList是双链表, 它有`Node<E> next`和` Node<E> prev`分别指向后一个结点和前一个结点, 我们基于此做一个简单的单链表示例, 参考: [这里](http://www.cs.cmu.edu/~adamchik/15-121/lectures/Linked%20Lists/code/LinkedList.java)  
...
public class MyLinkedList<AnyType> implements Iterable<AnyType> {
     ...
     *  Complexity: O(n)
     */
    public MyLinkedList<AnyType> copy2() {
        MyLinkedList<AnyType> twin = new MyLinkedList<AnyType>();
        Node<AnyType> tmp = head;
        while (tmp != null) {
    ...
    public MyLinkedList<AnyType> reverse() {
        MyLinkedList<AnyType> list = new MyLinkedList<AnyType>();
        Node<AnyType> tmp = head;
     ...
     *  Complexity: O(n)
     */
    public MyLinkedList<AnyType> copy3() {
        MyLinkedList<AnyType> twin = new MyLinkedList<AnyType>();
